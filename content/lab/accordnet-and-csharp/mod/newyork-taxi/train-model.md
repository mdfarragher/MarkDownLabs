...
We're going to continue with the code we wrote in the previous lab. That C# application set up an Accord.NET pipeline to load the New York TLC dataset and clean up the data using several feature engineering techniques.
