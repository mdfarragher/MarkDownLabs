...
printfn "Evaluating the model..."
let predictions = model.Transform(testingData)

// Evaluate the model's performance
let metrics = mlContext.Regression.Evaluate(predictions, labelColumnName = nameof<HousingData>.MedianHouseValue, scoreColumnName = "Score")

// Print evaluation metrics
printfn "Model evaluation metrics:"
printfn $"  R-squared: {metrics.RSquared:F4}"
printfn $"  Mean Absolute Error: {metrics.MeanAbsoluteError:F4}"
printfn $"  Mean Squared Error: {metrics.MeanSquaredError:F4}"
printfn $"  Root Mean Squared Error: {metrics.RootMeanSquaredError:F4}"
```
